...
VALUES (
  ...
  '{"type":"card-list","titleField":"title","descriptionField":"description","categoryField":"category","categories":{"plot_direction":{"label":"情节方向","icon":"MapPin","hue":210},"conflict":{"label":"冲突点","icon":"Zap","hue":35},"ending_variant":{"label":"结局变体","icon":"Flag","hue":280}}}',
